...
$(document).ready(function () {
    ...
    //         type: 'pie'
    //     },
    //     labels: townwisesale[0].labels,// ['Team A', 'Team B', 'Team C', 'Team D', 'Team E'],
    //     series: townwisesale[0].data,//[44, 55, 13, 43, 22],
    //     legend: {
    //         position: 'bottom'
    ...
    //         width: '100%'
    //     },
    //     labels: categorywisesale[0].labels,// ['Team A', 'Team B', 'Team C', 'Team D', 'Team E'],
    //     series: categorywisesale[0].data,//[44, 55, 13, 43, 22],
    //     legend: {
    //         position: 'bottom'
    //     },
    //     responsive: [{
    ...
    var options = {
        ...
        fill: {
            ...
            opacity: 0.85,
            image: {
                src: ['../../assets/images/products/headphone-1.jpg', '../../assets/images/products/iphone-1.jpg', '../../assets/images/products/speaker-2.jpg', '../../assets/images/products/watch-1.jpg'],
                width: 25,
                imagedHeight: 25
            }
        },
