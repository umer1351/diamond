...
@section('content')
        ...
        <div class="row pl-2">
            ...
            <div class="col-md-4">
                <input type="text" name="sale_no" id="sale_no"
                    value="{{ isset($other_sale) ? $other_sale->other_sale_no : 'OSL-05102024-0009' }}"
                            ...
                            <div class="card-body" style="font-size: 14px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="other_sale_date" id="other_sale_date"
                                                        class="form-control"
                                                        value="{{ isset($other_sale) ? $other_sale->other_sale_date : old('other_sale_date') }}"
                                                        required>
                                                </div>
                                            </div>
                                                    ...
                                                    <select id="warehouse_id" name="warehouse_id"
                                                        ...
                                                        @foreach ($warehouses as $item)
                                                            <option value="{{ $item->id }}"
                                                                @if (isset($other_sale)) {{ $other_sale->warehouse_id == $item->id ? 'selected' : '' }} @endif>
                                                                {{ $item->name ?? '' }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="row">
                                    <input type="hidden" class="form-control"
                                        value="{{ isset($other_sale) ? $other_sale->id : '' }}" id="id"
                                        name="id">
                                    <div class="col-md-12">
                                        <hr class="mb-2 mt-2">
                                        <b>Add Sale Detail:</b>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="other_product_id" name="other_product_id"
                                                ...
                                                @foreach ($other_products as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (isset($other_sale)) {{ $other_sale->other_product_id == $item->id ? 'selected' : '' }} @endif>
                                                        {{ $item->code ?? '' }} - {{ $item->name ?? '' }} ({{ $item->other_product_unit->name ?? '' }})
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="grand_total"
                                                                value="{{ isset($other_sale) ? $other_sale->total : '0' }}"
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="cash_amount"
                                                                value="{{ isset($other_sale) ? $other_sale->cash_amount : '0' }}"
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="bank_transfer_amount"
                                                                value="{{ isset($other_sale) ? $other_sale->bank_transfer_amount : '0' }}"
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="card_amount"
                                                                value="{{ isset($other_sale) ? $other_sale->card_amount : '0' }}"
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="advance_amount"
                                                                value="{{ isset($other_sale) ? $other_sale->advance_amount : '0' }}"
    ...
    @include('other_sale/Modal/CustomerModal')
@endsection
@section('js')
    <script src="{{ url('other-sale/js/other_sale.js') }}"></script>
    <script type="text/javascript">
        var url_local = "{{ url('/') }}";
        var other_sale_id = "{{ isset($other_sale) ? $other_sale->id : '' }}";
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            getCustomer();
            const other_sale_date = document.getElementById("other_sale_date");

            // ✅ Using the visitor's timezone
            other_sale_date.value = formatDate();
            ...
            other_sale_date.value = new Date().toISOString().split("T")[0];
        });
    </script>
@endsection
